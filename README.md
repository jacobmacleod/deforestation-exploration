# Deforestation Exploration - Udacity SQL Program
Deforestation Exploration Project for Udacity
...
### Files used
**queries.sql** - the queries written to write the report

**deforestation-exploration-solution.pdf** - the written report
